package com.smarthane.admiralcomponent.netease.mvp.model.api;

/**
 * @author smarthane
 * @time 2019/11/10 14:09
 * @describe
 */
public class Api {

    public static final String NETEASE_DOMAIN_NAME = "netease";
    public static final String NETEASE_DOMAIN = "http://c.m.163.com";
    ...
    // 新闻详情
    public static final String NEWS_DETAIL = NETEASE_DOMAIN + "/nc/article/";
