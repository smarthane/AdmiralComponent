...
import io.rx_cache3.core.ConfigProvider;
import io.rx_cache3.runtime.DynamicKey;
import io.rx_cache3.runtime.DynamicKeyGroup;
import io.rx_cache3.runtime.Encrypt;
import io.rx_cache3.core.EvictProvider;
import io.rx_cache3.runtime.Expirable;
import io.rx_cache3.runtime.LifeCache;
import io.rx_cache3.runtime.ProviderKey;
...
public final class ProxyTranslator {
  ...
  private Observable getLoaderObservable(Method method, Object[] objectsMethod) {
    ...
    String errorMessage =
        method.getName() + io.rx_cache3.core.internal.Locale.NOT_REACTIVE_TYPE_FOR_LOADER_WAS_FOUND;
  ...
  private <T> T getObjectFromMethodParam(Method method, Class<T> expectedClass,
    ...
    if (countSameObjectsType > 1) {
      String errorMessage =
          method.getName()
              + io.rx_cache3.core.internal.Locale.JUST_ONE_INSTANCE
