...
public final class DeleteRecordMatchingClassName {
  private final io.rx_cache3.core.internal.Persistence persistence;
  private final String encryptKey;
  private List<Class> classes;

  @Inject public DeleteRecordMatchingClassName(io.rx_cache3.core.internal.Persistence persistence, String encryptKey) {
  ...
  public Observable<Integer> react() {
    ...
    for (String key : allKeys) {
      io.rx_cache3.core.internal.Record record = persistence.retrieveRecord(key, false, encryptKey);
  ...
  private boolean evictRecord(io.rx_cache3.core.internal.Record record) {
