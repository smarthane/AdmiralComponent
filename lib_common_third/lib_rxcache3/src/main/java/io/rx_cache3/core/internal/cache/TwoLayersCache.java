...
public final class TwoLayersCache {
  ...
  private final io.rx_cache3.core.internal.cache.RetrieveRecord retrieveRecord;
  private final SaveRecord saveRecord;

  @Inject public TwoLayersCache(EvictRecord evictRecord, io.rx_cache3.core.internal.cache.RetrieveRecord retrieveRecord,
