...
package io.rx_cache3.core.internal.migration;

import io.reactivex.rxjava3.core.Observable;
import io.reactivex.rxjava3.core.ObservableSource;
import io.reactivex.rxjava3.functions.Function;
import io.rx_cache3.core.MigrationCache;
import io.rx_cache3.core.internal.Persistence;
import java.util.List;
import javax.inject.Inject;

public final class DoMigrations {
  private final io.rx_cache3.core.internal.migration.GetCacheVersion getCacheVersion;
  private final io.rx_cache3.core.internal.migration.GetPendingMigrations getPendingMigrations;
  private final io.rx_cache3.core.internal.migration.DeleteRecordMatchingClassName
      deleteRecordMatchingClassName;
  private final io.rx_cache3.core.internal.migration.UpgradeCacheVersion upgradeCacheVersion;
  ...
  @Inject public DoMigrations(Persistence persistence, List<MigrationCache> migrations,
    ...
    this.getCacheVersion = new io.rx_cache3.core.internal.migration.GetCacheVersion(persistence);
    this.getPendingMigrations = new io.rx_cache3.core.internal.migration.GetPendingMigrations();
    this.migrations = migrations;
    this.upgradeCacheVersion = new io.rx_cache3.core.internal.migration.UpgradeCacheVersion(persistence);
    this.deleteRecordMatchingClassName = new io.rx_cache3.core.internal.migration.DeleteRecordMatchingClassName(persistence, encryptKey);
  }
