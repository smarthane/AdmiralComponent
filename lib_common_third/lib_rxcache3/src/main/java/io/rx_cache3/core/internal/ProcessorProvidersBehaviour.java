...
package io.rx_cache3.core.internal;
...
import io.rx_cache3.core.EvictDynamicKey;
import io.rx_cache3.core.EvictDynamicKeyGroup;
import io.rx_cache3.core.Reply;
import io.rx_cache3.core.Source;
import io.rx_cache3.core.internal.cache.GetDeepCopy;
import java.util.concurrent.Callable;
import javax.inject.Inject;

public final class ProcessorProvidersBehaviour implements ProcessorProviders {
  private final io.rx_cache3.core.internal.cache.TwoLayersCache twoLayersCache;
  ...
  @Inject public ProcessorProvidersBehaviour(
      io.rx_cache3.core.internal.cache.TwoLayersCache twoLayersCache,
      Boolean useExpiredDataIfLoaderNotAvailable,
      io.rx_cache3.core.internal.cache.EvictExpiredRecordsPersistence evictExpiredRecordsPersistence,
      GetDeepCopy getDeepCopy, io.rx_cache3.core.internal.migration.DoMigrations doMigrations) {
  ...
  private Observable<Integer> startProcesses(
      io.rx_cache3.core.internal.migration.DoMigrations doMigrations,
      final io.rx_cache3.core.internal.cache.EvictExpiredRecordsPersistence evictExpiredRecordsPersistence) {
  ...
  @Override
  public <T> Observable<T> process(final io.rx_cache3.core.ConfigProvider configProvider) {
  ...
  //VisibleForTesting
  <T> Observable<T> getData(final io.rx_cache3.core.ConfigProvider configProvider) {
  ...
  private Observable<Reply> getDataFromLoader(final io.rx_cache3.core.ConfigProvider configProvider,
      final Record record) {
    return configProvider.getLoaderObservable().map(new Function<Object, Reply>() {
      @Override public Reply apply(Object data) throws Exception {
        ...
        if (data == null) {
          throw new io.rx_cache3.core.RxCacheException(io.rx_cache3.core.internal.Locale.NOT_DATA_RETURN_WHEN_CALLING_OBSERVABLE_LOADER
              + " "
  ...
  private void clearKeyIfNeeded(io.rx_cache3.core.ConfigProvider configProvider) {
  ...
  private Object getReturnType(io.rx_cache3.core.ConfigProvider configProvider, Reply reply) {
  ...
  @Override public Observable<Void> evictAll() {
    return Observable.defer(new Supplier<ObservableSource<Void>>() {
      @Override
      public ObservableSource<Void> get() throws Throwable {
