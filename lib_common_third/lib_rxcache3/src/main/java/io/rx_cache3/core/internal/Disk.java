...
import io.rx_cache3.core.internal.encrypt.FileEncryptor;
...
public final class Disk implements Persistence {
   ...
   */
  @Override public void saveRecord(String key, io.rx_cache3.core.internal.Record record, boolean isEncrypted,
      String encryptKey) {
  ...
  public void save(String key, Object data, boolean isEncrypted, String encryptKey) {
    ...
    if (data instanceof io.rx_cache3.core.internal.Record) {
   ...
   * @param encryptKey The key used to encrypt/decrypt the record to be persisted.
   */
  @Override public <T> io.rx_cache3.core.internal.Record<T> retrieveRecord(String key, boolean isEncrypted,
      String encryptKey) {
    key = safetyKey(key);
    ...
    try {
      ...
      Type partialType = jolyglot.newParameterizedType(io.rx_cache3.core.internal.Record.class, Object.class);
      io.rx_cache3.core.internal.Record tempDiskRecord = jolyglot.fromJson(file, partialType);
      ...
      io.rx_cache3.core.internal.Record<T> diskRecord;

      if (isCollection) {
        Type typeCollection = jolyglot.newParameterizedType(classCollectionData, classData);
        Type typeRecord = jolyglot.newParameterizedType(io.rx_cache3.core.internal.Record.class, typeCollection);
        diskRecord = jolyglot.fromJson(file.getAbsoluteFile(), typeRecord);
      } else if (isArray) {
        Type typeRecord = jolyglot.newParameterizedType(io.rx_cache3.core.internal.Record.class, classCollectionData);
        diskRecord = jolyglot.fromJson(file.getAbsoluteFile(), typeRecord);
      } else if (isMap) {
        ...
        Type typeRecord = jolyglot.newParameterizedType(io.rx_cache3.core.internal.Record.class, typeMap);
        diskRecord = jolyglot.fromJson(file.getAbsoluteFile(), typeRecord);
      } else {
        Type type = jolyglot.newParameterizedType(io.rx_cache3.core.internal.Record.class, classData);
