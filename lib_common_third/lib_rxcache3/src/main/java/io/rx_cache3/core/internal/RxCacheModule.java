...
import io.rx_cache3.core.internal.cache.memory.ReferenceMapMemory;
import io.rx_cache3.core.internal.encrypt.BuiltInEncryptor;
import io.rx_cache3.core.internal.encrypt.Encryptor;
...
public final class RxCacheModule {
  ...
  @Singleton @Provides Persistence providePersistence(io.rx_cache3.core.internal.Disk disk) {
    return disk;
  }
  ...
  @Singleton @Provides io.rx_cache3.core.internal.Memory provideMemory() {
  ...
  @Provides io.rx_cache3.core.internal.ProcessorProviders provideProcessorProviders(
      io.rx_cache3.core.internal.ProcessorProvidersBehaviour processorProvidersBehaviour) {
