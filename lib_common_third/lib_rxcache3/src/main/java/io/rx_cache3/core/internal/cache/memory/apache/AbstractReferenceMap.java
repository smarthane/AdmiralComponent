...
public abstract class AbstractReferenceMap<K, V> extends
    io.rx_cache3.core.internal.cache.memory.apache.AbstractHashedMap<K, V> {
    ...
    static class ReferenceEntrySet<K, V> extends EntrySet<K, V> {
        ...
        protected ReferenceEntrySet(final io.rx_cache3.core.internal.cache.memory.apache.AbstractHashedMap<K, V> parent) {
            super(parent);
        }
    ...
    static class ReferenceKeySet<K> extends KeySet<K> {
        ...
        protected ReferenceKeySet(final io.rx_cache3.core.internal.cache.memory.apache.AbstractHashedMap<K, ?> parent) {
            super(parent);
        }
    ...
    static class ReferenceValues<V> extends Values<V> {
        ...
        protected ReferenceValues(final io.rx_cache3.core.internal.cache.memory.apache.AbstractHashedMap<?, V> parent) {
            super(parent);
        }
