...
public class AbstractHashedMap<K, V> extends AbstractMap<K, V> implements IterableMap<K, V> {
     ...
     */
    public io.rx_cache3.core.internal.cache.memory.apache.MapIterator<K, V> mapIterator() {
        if (size == 0) {
    ...
    protected static class HashMapIterator<K, V> extends HashIterator<K, V> implements
        io.rx_cache3.core.internal.cache.memory.apache.MapIterator<K, V> {
    ...
    protected Iterator<Entry<K, V>> createEntrySetIterator() {
        if (size() == 0) {
            return io.rx_cache3.core.internal.cache.memory.apache.EmptyIterator.<Entry<K, V>>emptyIterator();
        }
    ...
    protected Iterator<K> createKeySetIterator() {
        if (size() == 0) {
            return io.rx_cache3.core.internal.cache.memory.apache.EmptyIterator.<K>emptyIterator();
        }
    ...
    protected Iterator<V> createValuesIterator() {
        if (size() == 0) {
            return io.rx_cache3.core.internal.cache.memory.apache.EmptyIterator.<V>emptyIterator();
        }
    ...
    protected static class HashEntry<K, V> implements Entry<K, V>,
        io.rx_cache3.core.internal.cache.memory.apache.KeyValue<K, V> {
    ...
    protected void doWriteObject(final ObjectOutputStream out) throws IOException {
        ...
        out.writeInt(size);
        for (final io.rx_cache3.core.internal.cache.memory.apache.MapIterator<K, V> it = mapIterator(); it.hasNext();) {
    ...
    public boolean equals(final Object obj) {
        ...
        final io.rx_cache3.core.internal.cache.memory.apache.MapIterator<?,?> it = mapIterator();
        try {
            while (it.hasNext()) {
    ...
    public String toString() {
        ...
        final io.rx_cache3.core.internal.cache.memory.apache.MapIterator<K, V> it = mapIterator();
