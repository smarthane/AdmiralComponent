...
public final class ConfigProvider {
  ...
  private void checkIntegrity() {
    if (evictProvider() instanceof io.rx_cache3.core.EvictDynamicKeyGroup
    ...
    if (evictProvider() instanceof io.rx_cache3.core.EvictDynamicKey
