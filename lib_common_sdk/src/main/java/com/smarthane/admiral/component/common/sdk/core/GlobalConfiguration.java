...
import com.smarthane.admiral.component.common.sdk.http.Api;
import com.smarthane.admiral.component.common.sdk.http.SSLSocketClient;
import com.smarthane.admiral.component.common.sdk.http.progressmanager.ProgressManager;
 ...
 * @describe GlobalConfiguration 含有有每个组件都可公用的配置信息, 每个组件的 AndroidManifest 都应该声明此 ConfigModule
 */
